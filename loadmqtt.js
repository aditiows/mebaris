...
temp = onMessageArrived(message) {if(message.destinationName = "mebaris01/nurusallam/lembap")};
humid = onMessageArrived(message) {if(message.destinationName = "mebaris01/nurusallam/lembap")};
